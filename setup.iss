...
AppVerName=EOS Camera Movie Record 0.1.10 Beta 2
...
AllowNoIcons=yes
OutputDir=dist
OutputBaseFilename=eos_movrec-0.1.10_beta2-setup
Compression=lzma
...
Source: "D:\develop\mingw\eos_movrec\dist\eos_movrec\libjpeg-7.dll"; DestDir: "{app}"; Flags: ignoreversion
