...
#define CAMERA_EVENT_AFMODE_CHANGED	(QEvent::Type)(QEvent::User + 11)
#define CAMERA_EVENT_ZOOM_CHANGED	(QEvent::Type)(QEvent::User + 12)
#define CAMERA_EVENT_ZOOM_CHANGED_STOP	(QEvent::Type)(QEvent::User + 13)
#define CAMERA_EVENT_ZOOMPOS_NEEDCHANGE	(QEvent::Type)(QEvent::User + 14)
#define CAMERA_EVENT_AF_STOPPED		(QEvent::Type)(QEvent::User + 15)
#define CAMERA_EVENT_HISTOGRAM		(QEvent::Type)(QEvent::User + 16)
#define CAMERA_EVENT_HISTOGRAM_CLOSED	(QEvent::Type)(QEvent::User + 17)
#define CAMERA_EVENT_ISO_CHANGED 	(QEvent::Type)(QEvent::User + 18)
#define CAMERA_EVENT_ISOLIST_CHANGED	(QEvent::Type)(QEvent::User + 19)
#define CAMERA_EVENT_FPS_CALCULATED		(QEvent::Type)(QEvent::User + 20)
